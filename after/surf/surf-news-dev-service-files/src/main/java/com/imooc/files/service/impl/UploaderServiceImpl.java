...
//        images/abc/10010/dog.png
    ...
    @Override
    public String uploadOBS(MultipartFile file, String userId, String fileExtName) throws Exception {
        String endPoint = "https://"+fileResource.getObsEndpoint();
        String ak = "";
        String sk = "";
        // 创建ObsClient实例
        ...
        String fileName = sid.nextShort();
        String myObjectName = fileResource.getObsObjectName()
                + "/" + userId + "/" + fileName + "." + fileExtName;

        // 使用访问OBS
        InputStream inputStream = file.getInputStream();
        obsClient.putObject(fileResource.getObsBucketName(), myObjectName, inputStream);
