...
public class BaseController {
    ...
    public static final String REDIS_ARTICLE_TOP = "redis_article_top";

    public static final String REDIS_SUBMIT_COMMENT_DUP = "redis_submit_comment_dup";
    public static final String REDIS_SUBMIT_ARTICLE_DUP = "redis_submit_article_dup";
    ...
    public void setCookieValue(HttpServletRequest request,
                          ...
                          String cookieValue,
                          Integer maxAge) {
        System.out.println("domainName是"+DOMAIN_NAME);
