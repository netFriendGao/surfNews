...
{
    public  void sendSms(String phone,String authCode)
    {
        try {
            /* 必要步骤：
            ...
            Credential cred = new Credential("AKID87rNegT1KNGzVovpVv73kBNM7duwiFXZ",
                    "rSoulMhngLmzxjGYdS2MblkX6RYR6Ymp");
