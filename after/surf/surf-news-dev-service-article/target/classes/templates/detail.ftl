...
<#--                        <a href="https://class.imooc.com/sale/javaarchitect" class="white-header-left">架构师</a>-->
<#--                    </div>-->
<#--                </div>-->
            </div>
        ...
        <div class="detail-really">
            ...
            <div class="left-social">
                ...
                <div class="imooc-words">
                    <span class="imooc-num">冲浪媒体号</span>
                </div>
            ...
            <div class="container-middle">
                <div class="article-wrapper">
                    ...
                    <div class="declare">
                        免责声明：本平台所有内容仅供测试，且文章来自互联网，不代表冲浪新闻的观点和立场，如有不妥，请联系后删除。
                    </div>
                </div>
